...
Dictionaries provide methods to easily access their keys, values, or key-value pairs as view objects. 

The `.keys()` method returns a view object that displays a list of all the keys in the dictionary. This view reflects any changes made to the dictionary.
...
The `.values()` method returns a view object that displays a list of all the values in the dictionary. Like `.keys()`, this view is dynamic and reflects changes.

````python
student_values = student.values()
print(student_values) # Output: dict_values(['Alex', 101, 'Physics'])
...
The `.items()` method returns a view object that displays a list of the dictionary's key-value pairs as tuples. This is often the most convenient way to iterate over both keys and values simultaneously.

````python
student_items = student.items()
print(student_items) # Output: dict_items([('name', 'Alex'), ('id', 101), ('major', 'Physics')])
