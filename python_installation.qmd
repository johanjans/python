...
1. Use the [Python Development Installer](#python-dev-installer-windows) — it handles everything: Git, VS Code, Python, and Marimo
2. Read [Working with the Terminal](#working-with-the-terminal) for package management commands
...
::: {.callout-note}
## Installer Users
The [Python Development Installer](#python-dev-installer-windows) automatically sets the PowerShell execution policy and enables the classic context menu. You only need this section if you want additional configuration (like disabling SmartScreen) or if you're setting up manually.
:::
...
If the battle against Windows defaults ever feels exhausting, you are not alone. [Here is a song about it.](assets/No%20room%20to%20run.mp3)
:::
...
## Python Development Installer (Windows) {#python-dev-installer-windows}
...
That's it. Follow the on-screen prompts and you're done.
:::

::: {.callout-tip collapse="true"}
## Alternative: Manual Download

[Download Installer](https://github.com/cenmir/python-dev-installer/archive/refs/heads/main.zip){.btn .btn-primary .btn-lg}
...
- Creates a virtual environment at `C:\Users\username\.venvs\default`
...
- Adds `activate default` command to quickly activate the environment
- Adds `m` command to launch Marimo from any terminal
- Creates Start Menu shortcuts for Marimo
...
::: {.callout-note}
## Windows Users
If you used the [Python Development Installer](#python-dev-installer-windows), VS Code is already installed and configured. Skip to [Using VS Code with Your Virtual Environment](#using-vs-code-with-your-virtual-environment).
:::
...
This section covers manual installation for macOS/Linux users and Windows users who prefer more control over the setup process. If you used the [Python Development Installer](#python-dev-installer-windows) on Windows, skip this section.
...
```powershell
uv pip install marimo numpy sympy scipy matplotlib pandas pyqt6 pyqtgraph imageio ipykernel
```
...
| `imageio` | Library for reading and writing image and video data |
