...
Let $[a_k, b_k]$ denote the interval after $k$ iterations. The algorithm systematically shrinks this interval. At each step, we select one of the two halves, so the interval length decreases by exactly a factor of two:
$$
